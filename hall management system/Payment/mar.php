<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        do {
            ...
            $sql = "INSERT INTO mar (hall_id, id, name, room, month, year) " . "VALUES('$hall_id','$id','$name','$room','$month','$year')";
            ...
            header("location:/hall management system/Payment/mar.php");
            exit;
        } while (false);
    }
?>
    ...
    <div class="row" id="header">
        ...
        <div class="month">
            <ul>
                ...
                <li type="none" style="text-decoration: underline;"> <a href="#"> March</a></li>
        ...
        <div class="container my-5">
            <table class="table">
                ...
                if(isset($_POST['submit'])){
                    $search = $_POST['search'];
                    $sql = "Select * from mar where hall_id ='$search' or id ='$search' or name='$search' or month ='$search' ";
