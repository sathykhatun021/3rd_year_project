<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        do {
            ...
            $sql = "INSERT INTO june (hall_id, id, name, room, month, year) " . "VALUES('$hall_id','$id','$name','$room','$month','$year')";
            ...
            header("location:/hall management system/Payment/june.php");
            exit;
        } while (false);
    }
?>
    ...
    <div class="row" id="header">
        ...
        <div class="month">
            <ul>
                ...
                <li type="none" style="text-decoration: underline;"> <a href="#"> June</a></li>
        ...
        <div class="container my-5">
            <table class="table">
                ...
                if(isset($_POST['submit'])){
                    $search = $_POST['search'];
                    $sql = "Select * from june where hall_id ='$search' or id ='$search' or name='$search' or month ='$search' ";
